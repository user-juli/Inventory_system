...
<?php
 if(isset($_POST['add_product'])){
   $req_fields = array('code','product-title','product-categorie','product-quantity','buying-price', 'saleing-price','provider');
   ...
   if(empty($errors)){
     ...
     $query .=" code,name,stock,buy_price,sale_price,categorie_id,media_id,date,provider_id,store_id";
     $query .=") VALUES (";
     $query .=" '{$p_code}', '{$p_name}', '{$p_qty}', '{$p_buy}', '{$p_sale}', '{$p_cat}', '{$media_id}', '{$date}', '{$p_prov}' ";
     $query .=")";
              ...
              <div class="row">
                <div class="col-md-4">
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="code" placeholder="Codigo Producto">
                  </div>
                </div>
                <div class="col-md-8">
                  <div class="input-group">
                ...
                <div class="col-md-6">
                  <select class="form-control" name="provider">
                    ...
                    <option value="<?php echo (int)$provider['id'] ?>">
                      <?php echo $provider['tradename'] ?></option>
                  <?php endforeach; ?>
                  </select>
                </div>
              </div>
