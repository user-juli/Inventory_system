           ...
           <thead>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <input type="text" class="form-control" name="user" value="<?php echo remove_junk(ucfirst($user['id'])); ?>" readonly>
              </div>
            </div> 
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-header">
            <h4 class="modal-title">Cuenta por Cobrar</h4>
            <button type="button" class="close" data-dismiss="modal">&times;</button>
          </div>

          <div class="modal-body">
            <input type="text" name="bono" placeholder="Monto a abonar">
          </div>

          <div class="modal-footer">
            <a href="debts.php"><button type="button" class="btn btn-danger" data-dismiss="modal">Guardar</button></a> 
          </div>
